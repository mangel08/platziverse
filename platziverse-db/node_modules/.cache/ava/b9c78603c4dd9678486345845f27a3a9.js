...
test.serial('Metric#findByAgentUuid', async t => {
  ...
  t.is(metric.length, metricFixtures.findByAgentUuid.length, 'metrics should be the same');
  t.deepEqual(metric, metricFixtures.findByAgentUuid, 'metrics should be the same');
});
//# sourceMappingURL=/var/www/html/platziverse/platziverse-db/node_modules/.cache/ava/b9c78603c4dd9678486345845f27a3a9.js.map