...
test.serial('Agent#findByUuid', async t => {
  ...
  t.true(_rec18._expr(_rec18._capt(_rec18._capt(_rec18._capt(AgentStub, 'arguments/0/object/object').findByUuid, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec19._expr(_rec19._capt(_rec19._capt(_rec19._capt(AgentStub, 'arguments/0/object/object').findByUuid, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AgentStub.findByUuid.calledOnce, \'findByUuid should be called once\')',
    filepath: 'tests/agent-test.js',
    line: 135,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByUuid","range":[17,27]},"computed":false,"range":[7,27]},"property":{"type":"Identifier","name":"calledOnce","range":[28,38]},"computed":false,"range":[7,38]},{"type":"StringLiteral","value":"findByUuid should be called once","range":[40,74]}],"range":[0,75]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUuid","range":[17,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"calledOnce","range":[28,38]},{"type":{"label":","},"range":[38,39]},{"type":{"label":"string"},"value":"findByUuid should be called once","range":[40,74]},{"type":{"label":")"},"range":[74,75]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUuid should be called once');
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AgentStub, 'arguments/0/callee/object/object').findByUuid, 'arguments/0/callee/object').calledWith(_rec20._capt(uuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findByUuid.calledWith(uuidArgs), \'findByUuid should be called with uuidArgs\')',
    filepath: 'tests/agent-test.js',
    line: 136,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByUuid","range":[17,27]},"computed":false,"range":[7,27]},"property":{"type":"Identifier","name":"calledWith","range":[28,38]},"computed":false,"range":[7,38]},"arguments":[{"type":"Identifier","name":"uuidArgs","range":[39,47]}],"range":[7,48]},{"type":"StringLiteral","value":"findByUuid should be called with uuidArgs","range":[50,93]}],"range":[0,94]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUuid","range":[17,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"calledWith","range":[28,38]},{"type":{"label":"("},"range":[38,39]},{"type":{"label":"name"},"value":"uuidArgs","range":[39,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":","},"range":[48,49]},{"type":{"label":"string"},"value":"findByUuid should be called with uuidArgs","range":[50,93]},{"type":{"label":")"},"range":[93,94]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUuid should be called with uuidArgs');

  t.deepEqual(agent, agentFixtures.byId(uuidArgs), 'should be the same');
});
...
test.serial('Agent#findConnected', async t => {
  ...
  t.true(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(AgentStub, 'arguments/0/object/object').findConnected, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AgentStub.findConnected.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/agent-test.js',
    line: 156,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findConnected","range":[17,30]},"computed":false,"range":[7,30]},"property":{"type":"Identifier","name":"calledOnce","range":[31,41]},"computed":false,"range":[7,41]},{"type":"StringLiteral","value":"findAll should be called once","range":[43,74]}],"range":[0,75]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findConnected","range":[17,30]},{"type":{"label":"."},"range":[30,31]},{"type":{"label":"name"},"value":"calledOnce","range":[31,41]},{"type":{"label":","},"range":[41,42]},{"type":{"label":"string"},"value":"findAll should be called once","range":[43,74]},{"type":{"label":")"},"range":[74,75]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called once');
  t.true(_rec26._expr(_rec26._capt(_rec26._capt(_rec26._capt(AgentStub, 'arguments/0/callee/object/object').findConnected, 'arguments/0/callee/object').calledWith(_rec26._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findConnected.calledWith(connectedArgs), \'findAll should be called with connectedArgs\')',
    filepath: 'tests/agent-test.js',
    line: 157,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findConnected","range":[17,30]},"computed":false,"range":[7,30]},"property":{"type":"Identifier","name":"calledWith","range":[31,41]},"computed":false,"range":[7,41]},"arguments":[{"type":"Identifier","name":"connectedArgs","range":[42,55]}],"range":[7,56]},{"type":"StringLiteral","value":"findAll should be called with connectedArgs","range":[58,103]}],"range":[0,104]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findConnected","range":[17,30]},{"type":{"label":"."},"range":[30,31]},{"type":{"label":"name"},"value":"calledWith","range":[31,41]},{"type":{"label":"("},"range":[41,42]},{"type":{"label":"name"},"value":"connectedArgs","range":[42,55]},{"type":{"label":")"},"range":[55,56]},{"type":{"label":","},"range":[56,57]},{"type":{"label":"string"},"value":"findAll should be called with connectedArgs","range":[58,103]},{"type":{"label":")"},"range":[103,104]}]',
    visitorKeys: _powerAssertVisitorKeys
...
test.serial('Agent#findByUsername', async t => {
  ...
  let agents = await db.Agent.findByUsername();

  t.true(_rec27._expr(_rec27._capt(_rec27._capt(_rec27._capt(AgentStub, 'arguments/0/object/object').findByUsername, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.findByUsername.called, \'findByUsername should be called on model\')',
    filepath: 'tests/agent-test.js',
    line: 166,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByUsername","range":[17,31]},"computed":false,"range":[7,31]},"property":{"type":"Identifier","name":"called","range":[32,38]},"computed":false,"range":[7,38]},{"type":"StringLiteral","value":"findByUsername should be called on model","range":[40,82]}],"range":[0,83]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUsername","range":[17,31]},{"type":{"label":"."},"range":[31,32]},{"type":{"label":"name"},"value":"called","range":[32,38]},{"type":{"label":","},"range":[38,39]},{"type":{"label":"string"},"value":"findByUsername should be called on model","range":[40,82]},{"type":{"label":")"},"range":[82,83]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUsername should be called on model');
  t.true(_rec28._expr(_rec28._capt(_rec28._capt(_rec28._capt(AgentStub, 'arguments/0/object/object').findByUsername, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AgentStub.findByUsername.calledOnce, \'findByUsername should be called once\')',
    filepath: 'tests/agent-test.js',
    line: 167,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByUsername","range":[17,31]},"computed":false,"range":[7,31]},"property":{"type":"Identifier","name":"calledOnce","range":[32,42]},"computed":false,"range":[7,42]},{"type":"StringLiteral","value":"findByUsername should be called once","range":[44,82]}],"range":[0,83]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUsername","range":[17,31]},{"type":{"label":"."},"range":[31,32]},{"type":{"label":"name"},"value":"calledOnce","range":[32,42]},{"type":{"label":","},"range":[42,43]},{"type":{"label":"string"},"value":"findByUsername should be called once","range":[44,82]},{"type":{"label":")"},"range":[82,83]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUsername should be called once');
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AgentStub, 'arguments/0/callee/object/object').findByUsername, 'arguments/0/callee/object').calledwith(_rec29._capt(usernameArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findByUsername.calledwith(usernameArgs), \'findByUsername should be called with usernameArgs\')',
    filepath: 'tests/agent-test.js',
    line: 168,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByUsername","range":[17,31]},"computed":false,"range":[7,31]},"property":{"type":"Identifier","name":"calledwith","range":[32,42]},"computed":false,"range":[7,42]},"arguments":[{"type":"Identifier","name":"usernameArgs","range":[43,55]}],"range":[7,56]},{"type":"StringLiteral","value":"findByUsername should be called with usernameArgs","range":[58,109]}],"range":[0,110]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUsername","range":[17,31]},{"type":{"label":"."},"range":[31,32]},{"type":{"label":"name"},"value":"calledwith","range":[32,42]},{"type":{"label":"("},"range":[42,43]},{"type":{"label":"name"},"value":"usernameArgs","range":[43,55]},{"type":{"label":")"},"range":[55,56]},{"type":{"label":","},"range":[56,57]},{"type":{"label":"string"},"value":"findByUsername should be called with usernameArgs","range":[58,109]},{"type":{"label":")"},"range":[109,110]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUsername should be called with usernameArgs');
...
//# sourceMappingURL=/var/www/html/platziverse/platziverse-db/node_modules/.cache/ava/68d6e76b8721027b4a70b7e2956a89b1.js.map