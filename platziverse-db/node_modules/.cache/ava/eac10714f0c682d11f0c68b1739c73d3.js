...
test.serial('Agent#findByUuid', async t => {
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec20._capt(_rec20._capt(_rec20._capt(uuidArgs, 'arguments/0/arguments/0/object/object').where, 'arguments/0/arguments/0/object').uuid, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findOne.calledWith(uuidArgs.where.uuid), \'findOne should be called with uuidArgs\')',
    filepath: 'tests/agent-test.js',
    line: 137,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"uuidArgs","range":[36,44]},"property":{"type":"Identifier","name":"where","range":[45,50]},"computed":false,"range":[36,50]},"property":{"type":"Identifier","name":"uuid","range":[51,55]},"computed":false,"range":[36,55]}],"range":[7,56]},{"type":"StringLiteral","value":"findOne should be called with uuidArgs","range":[58,98]}],"range":[0,99]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"uuidArgs","range":[36,44]},{"type":{"label":"."},"range":[44,45]},{"type":{"label":"name"},"value":"where","range":[45,50]},{"type":{"label":"."},"range":[50,51]},{"type":{"label":"name"},"value":"uuid","range":[51,55]},{"type":{"label":")"},"range":[55,56]},{"type":{"label":","},"range":[56,57]},{"type":{"label":"string"},"value":"findOne should be called with uuidArgs","range":[58,98]},{"type":{"label":")"},"range":[98,99]}]',
    visitorKeys: _powerAssertVisitorKeys
...
test.serial('Agent#findByUsername', async t => {
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AgentStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec29._capt(usernameArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findAll.calledWith(usernameArgs), \'findAll should be called with usernameArgs\')',
    filepath: 'tests/agent-test.js',
    line: 169,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findAll","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"usernameArgs","range":[36,48]}],"range":[7,49]},{"type":"StringLiteral","value":"findAll should be called with usernameArgs","range":[51,95]}],"range":[0,96]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findAll","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"usernameArgs","range":[36,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"findAll should be called with usernameArgs","range":[51,95]},{"type":{"label":")"},"range":[95,96]}]',
    visitorKeys: _powerAssertVisitorKeys
...
//# sourceMappingURL=/var/www/html/platziverse/platziverse-db/node_modules/.cache/ava/eac10714f0c682d11f0c68b1739c73d3.js.map