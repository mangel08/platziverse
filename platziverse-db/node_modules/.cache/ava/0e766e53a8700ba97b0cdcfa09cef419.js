...
test('Agent', t => {
  ...
  t.truthy(_rec2._expr(_rec2._capt(_rec2._capt(db, 'arguments/0/object').Metric, 'arguments/0'), {
    content: 't.truthy(db.Metric, \'Agent service should exist\')',
    filepath: 'tests/metric-test.js',
    line: 68,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"db","range":[9,11]},"property":{"type":"Identifier","name":"Metric","range":[12,18]},"computed":false,"range":[9,18]},{"type":"StringLiteral","value":"Agent service should exist","range":[20,48]}],"range":[0,49]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"db","range":[9,11]},{"type":{"label":"."},"range":[11,12]},{"type":{"label":"name"},"value":"Metric","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"string"},"value":"Agent service should exist","range":[20,48]},{"type":{"label":")"},"range":[48,49]}]',
    visitorKeys: _powerAssertVisitorKeys
...
test.serial('Setup', t => {
  ...
  t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(AgentStub, 'arguments/0/callee/object/object').hasMany, 'arguments/0/callee/object').calledWith(_rec4._capt(MetricStub, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(MetricStub, 'arguments/0/callee/object/object').belongsTo, 'arguments/0/callee/object').calledWith(_rec6._capt(AgentStub, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('Metric#Create', async t => {
  ...
  let metric = await db.Metric.create(single);

  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec9._capt(uuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(MetricStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(MetricStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(MetricStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec12._capt(newMetric, 'arguments/0/arguments/0')), 'arguments/0'), {
...
//# sourceMappingURL=/var/www/html/platziverse/platziverse-db/node_modules/.cache/ava/0e766e53a8700ba97b0cdcfa09cef419.js.map